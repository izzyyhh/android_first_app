...
import com.example.mobilevo2.databinding.ProfilePostListItemBinding
...
class ProfilePostsListAdapter : ListAdapter<DocumentReference, ProfilePostsListAdapter.ProfilePostsViewHolder>(DIFF_UTIL){
    ...
    class ProfilePostsViewHolder(private val binding: ProfilePostListItemBinding) : RecyclerView.ViewHolder(binding.root){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ProfilePostsViewHolder {
        ...
        val binding = ProfilePostListItemBinding.inflate(inflater, parent, false)
